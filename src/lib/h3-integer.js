...
export function leftShiftH3Integer(h3Integer, bits, result = [0, 0]) {
 ...
 */
export function rightShiftH3Integer(h3Integer, bits, result = [0, 0]) {
  assert(bits <= INT_SIZE);
  result[LO_PART] = h3Integer[LO_PART];
  result[HI_PART] = h3Integer[HI_PART];
...
export function orH3Integers(left, right, result = [0, 0]) {
  result[LO_PART] = left[LO_PART] | right[LO_PART];
  result[HI_PART] = left[HI_PART] | right[HI_PART];
  return result;
}

export function maskLeftBits(h3Integer, bits, result = [0, 0]) {
...
export function addH3Integers(left, right, result = [0, 0]) {
...
export function scaleH3Integer(scalar, value, result = [0, 0]) {
 ...
 * @param {number} num
 */
export function hexFrom32Bit(num) {
  if (num >= 0) {
 ...
 */
export function h3IntegerToString(h3Integer) {
  // Change from H3:
...
export function stringToH3Integer(h3Index, result = [0, 0]) {
  // From uber/h3-js
...
export function unshortenH3Integer(shortH3Integer, result = [0, 0]) {
